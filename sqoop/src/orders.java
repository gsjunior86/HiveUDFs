...
//
// Debug information:
// Generated date: Tue Mar 01 14:19:07 PST 2016
...
public class orders extends SqoopRecord  implements DBWritable, Writable {
  ...
  public orders with_customer_id(String customer_id) {
    this.customer_id = customer_id;
    return this;
  }
  ...
  public orders with_amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.order_date = JdbcWritableBridge.readDate(2, __dbResults);
    this.customer_id = JdbcWritableBridge.readString(3, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeDate(order_date, 2 + __off, 91, __dbStmt);
    JdbcWritableBridge.writeString(customer_id, 3 + __off, 12, __dbStmt);
